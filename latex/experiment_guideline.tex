...
Chronos-2 and Chronos-Bolt, official TS-ICL and TiRex-2 adapters, and in-context
TabPFN-TS. \\
...
All foundation-model adapters use their official packages. TS-ICL and TiRex-2
retain native preprocessing and
...
\item \code{04_foundation_models.slurm}: frozen Chronos-2, Chronos-Bolt,
      TS-ICL, and TabPFN-TS with model-native preprocessing. TiRex-2 remains
      implemented but is excluded from the launcher until explicitly restored.
\end{enumerate}
